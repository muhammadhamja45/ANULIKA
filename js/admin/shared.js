...
const ICON_PACKAGE = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" class="h-5 w-5"><path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5 12 2.25 3 7.5m18 0-9 5.25m9-5.25v9L12 21m-9-13.5 9 5.25M3 7.5v9l9 4.5m0-9v9"/></svg>`;
...
const NAV_ITEMS = [
  ...
  { href: 'packages.html', label: 'Paket', icon: ICON_PACKAGE, roles: ['admin', 'editor'] },
